...
print(list(pseg.cut('拉开压变开关')))
print(list(pseg.cut('检查压变开关三相确在分闸位置')))
print(list(pseg.cut('将压变刀闸手车由“工作”位置摇至“试验”位置')))
print(list(pseg.cut('检查压变刀闸手车确在“试验”位置')))
print(list(pseg.cut('将压变刀闸手车由“试验”位置摇至“工作”位置')))
print(list(pseg.cut('检查压变刀闸手车确在“工作”位置')))
print(list(pseg.cut('合上压变刀闸')))
print(list(pseg.cut('检查压变刀闸三相确已合上')))